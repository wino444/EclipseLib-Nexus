-- EclipseLib-Nexus Elements Library (Single File)
return function(deps)
    ...
    local CC = Utils.CC; local CS = Utils.CS; local Tween = Utils.Tween
    ...
    Elements.Section = function(parent, options)
        ...
        line.BackgroundColor3 = Theme.Border; line.Size = UDim2.new(1,0,0,1); line.Position = UDim2.new(0,0,0.5,0); line.BorderSizePixel = 0; line.Parent = sectionFrame
        local bg = Instance.new("Frame")
        bg.BackgroundColor3 = Theme.Background; bg.AutomaticSize = Enum.AutomaticSize.X; bg.Size = UDim2.new(0,0,1,0); bg.Parent = sectionFrame
        local lbl = Instance.new("TextLabel")
        lbl.BackgroundTransparency = 1; lbl.AutomaticSize = Enum.AutomaticSize.X; lbl.Size = UDim2.new(0,0,1,0); lbl.Text = " "..(options.Name or "Section").." "; lbl.TextColor3 = Theme.Accent; lbl.Font = Enum.Font.GothamBold; lbl.TextSize = 11; lbl.Parent = bg
        return {}
    end
    ...
    Elements.Button = function(parent, options)
        ...
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.6,0,0,18); nL.Text=options.Name or "Button"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        local dL = Instance.new("TextLabel"); dL.BackgroundTransparency=1; dL.Position=UDim2.new(0,10,0,26); dL.Size=UDim2.new(0.6,0,0,16); dL.Text=options.Description or ""; dL.TextColor3=Theme.SubText; dL.Font=Enum.Font.Gotham; dL.TextSize=10; dL.TextXAlignment=Enum.TextXAlignment.Left; dL.Parent=card
        if options.RealtimeValue then
            local rL = Instance.new("TextLabel"); rL.BackgroundTransparency=1; rL.Position=UDim2.new(0.58,0,0,6); rL.Size=UDim2.new(0.24,0,0,18); rL.Text=tostring(options.RealtimeValue()); rL.TextColor3=Theme.Accent; rL.Font=Enum.Font.GothamBold; rL.TextSize=11; rL.TextXAlignment=Enum.TextXAlignment.Right; rL.Parent=card
            if MemoryGuard then MemoryGuard:Register(rL, function(lbl) lbl.Text=tostring(options.RealtimeValue()) end) end
        end
        ...
        btn.MouseButton1Click:Connect(function() Tween(btn,{BackgroundColor3=Theme.AccentHover},0.1); task.wait(0.1); Tween(btn,{BackgroundColor3=Theme.Accent},0.1); if options.Callback then options.Callback() end end)
        return {}
    end
    ...
    Elements.Toggle = function(parent, options)
        ...
        local card = BaseCard(parent, 50)
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.7,0,0,18); nL.Text=options.Name or "Toggle"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        local dL = Instance.new("TextLabel"); dL.BackgroundTransparency=1; dL.Position=UDim2.new(0,10,0,26); dL.Size=UDim2.new(0.7,0,0,16); dL.Text=options.Description or ""; dL.TextColor3=Theme.SubText; dL.Font=Enum.Font.Gotham; dL.TextSize=10; dL.TextXAlignment=Enum.TextXAlignment.Left; dL.Parent=card
        ...
        if options.ConfigKey and ConfigManager then ConfigManager:Register(options.ConfigKey, function() return state end, Apply) end
    ...
    Elements.Slider = function(parent, options)
        options = options or {}
        local min = options.Min or 0; local max = options.Max or 100
        local value = math.clamp(options.Default or min, min, max)
        local card = BaseCard(parent, 60)
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.7,0,0,18); nL.Text=options.Name or "Slider"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        ...
        local function upd(pos)
            ...
            value = math.floor(min + (max-min)*r)
            vL.Text = tostring(value); fi.Size = UDim2.new(r,0,1,0)
        ...
        if options.ConfigKey and ConfigManager then ConfigManager:Register(options.ConfigKey, function() return value end, function(v) value=math.clamp(v,min,max); local r=(value-min)/(max-min); fi.Size=UDim2.new(r,0,1,0); vL.Text=tostring(value); if options.Callback then options.Callback(value) end end) end
        return { GetValue = function() return value end, SetValue = function(v) value=math.clamp(v,min,max); local r=(value-min)/(max-min); fi.Size=UDim2.new(r,0,1,0); vL.Text=tostring(value); if options.Callback then options.Callback(value) end end }
    end
    ...
    Elements.Dropdown = function(parent, options)
        ...
        local wrapper = Instance.new("Frame"); wrapper.BackgroundTransparency=1; wrapper.Size=UDim2.new(1,0,0,46); wrapper.ClipsDescendants=false; wrapper.Parent=parent
        ...
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.55,0,0,14); nL.Text=options.Name or "Dropdown"; nL.TextColor3=Theme.SubText; nL.Font=Enum.Font.Gotham; nL.TextSize=11; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        ...
        if options.RealtimeValue then
            local rL = Instance.new("TextLabel"); rL.BackgroundTransparency=1; rL.Position=UDim2.new(0.6,0,0,22); rL.Size=UDim2.new(0.2,0,0,18); rL.Text=tostring(options.RealtimeValue()); rL.TextColor3=Theme.Accent; rL.Font=Enum.Font.GothamBold; rL.TextSize=11; rL.TextXAlignment=Enum.TextXAlignment.Right; rL.Parent=card
            if MemoryGuard then MemoryGuard:Register(rL, function(lbl) lbl.Text=tostring(options.RealtimeValue()) end) end
        end
        ...
        local function populate()
            ...
            for _,item in ipairs(items) do
                ...
                ib.MouseButton1Click:Connect(function() selected=item; sL.Text=item; expanded=false; dl.Visible=false; ab.Text="▼"; if options.Callback then options.Callback(item) end end)
            end
        ...
        if options.ConfigKey and ConfigManager then ConfigManager:Register(options.ConfigKey, function() return selected end, function(v) selected=v; sL.Text=v; if options.Callback then options.Callback(v) end end) end
    ...
    Elements.Input = function(parent, options)
        options = options or {}
        local card = BaseCard(parent, 60)
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(1,-20,0,16); nL.Text=options.Name or "Input"; nL.TextColor3=Theme.SubText; nL.Font=Enum.Font.Gotham; nL.TextSize=11; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        ...
        local box = Instance.new("TextBox"); box.BackgroundTransparency=1; box.Size=UDim2.new(1,-10,1,0); box.Position=UDim2.new(0,6,0,0); box.PlaceholderText=options.Placeholder or "พิมพ์ที่นี่..."; box.PlaceholderColor3=Theme.SubText; box.TextColor3=Theme.Text; box.Font=Enum.Font.Gotham; box.TextSize=12; box.TextXAlignment=Enum.TextXAlignment.Left; box.ClearTextOnFocus=false; box.Text=""; box.Parent=iBG
        box.FocusLost:Connect(function(ep) if ep and options.Callback then options.Callback(box.Text) end end)
    ...
    Elements.ProgressBar = function(parent, options)
        ...
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.7,0,0,16); nL.Text=options.Name or "Progress"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
    ...
    Elements.Paragraph = function(parent, options)
        options = options or {}
        local titleText = options.Title or ""; local contentText = options.Content or ""
    ...
    Elements.ColorPicker = function(parent, options)
        ...
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.6,0,0,18); nL.Text=options.Name or "ColorPicker"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        ...
        if MemoryGuard then MemoryGuard:Register(hexLabel, function(lbl) lbl.Text="Color3.fromRGB("..rVal..","..gVal..","..bVal..")" end) end
    ...
    Elements.Keybind = function(parent, options)
        ...
        local card = BaseCard(parent, 50)
        local nL = Instance.new("TextLabel"); nL.BackgroundTransparency=1; nL.Position=UDim2.new(0,10,0,6); nL.Size=UDim2.new(0.55,0,0,18); nL.Text=options.Name or "Keybind"; nL.TextColor3=Theme.Text; nL.Font=Enum.Font.GothamBold; nL.TextSize=13; nL.TextXAlignment=Enum.TextXAlignment.Left; nL.Parent=card
        local dL = Instance.new("TextLabel"); dL.BackgroundTransparency=1; dL.Position=UDim2.new(0,10,0,26); dL.Size=UDim2.new(0.55,0,0,16); dL.Text=options.Description or ""; dL.TextColor3=Theme.SubText; dL.Font=Enum.Font.Gotham; dL.TextSize=10; dL.TextXAlignment=Enum.TextXAlignment.Left; dL.Parent=card
        ...
        if isMobile then
            ...
            keyBtn.MouseButton1Click:Connect(function() Tween(keyBtn,{BackgroundColor3=Theme.AccentHover},0.1); task.wait(0.1); Tween(keyBtn,{BackgroundColor3=Theme.Accent},0.15); if options.Callback then options.Callback() end end)
        else
            ...
            UserInputService.InputBegan:Connect(function(input,gp) if gp or isListening then return end; if input.UserInputType==Enum.UserInputType.Keyboard and input.KeyCode==currentKey then if options.Callback then options.Callback() end end end)
        end
    ...
    Elements.Card = function(parent, options)
        options = options or {}
        local titleText = options.Title or "Card"; local contentText = options.Content or ""
